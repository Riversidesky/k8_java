...
public class Test01 {
	public static void main(String[] args) {
		...
		List<String> vec = new Vector<String>(); //다형성
//		ArrayList<String> list = new ArrayList<String>(); 동기화 X
//		Vector<String> vec = new Vector<String>(); 동기화 O
		vec.add("Abcd");
